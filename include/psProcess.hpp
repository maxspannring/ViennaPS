...
public:
  ...
  void apply() {
    ...
    meshConverter.insertNextLevelSet(domain->getWrappingLevelSet());
    advectionKernel.insertNextLevelSet(domain->getWrappingLevelSet());
...
private:
  ...
  moveCoveragesToTopLS(lsSmartPointer<translatorType> translator,
    ...
    auto topLS = domain->getWrappingLevelSet();
